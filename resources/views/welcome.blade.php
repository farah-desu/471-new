...
<body>
    ...
    <section id="features" class="features">
        ...
        <div class="feature-list">
            <div class="feature">
                ...
                <p>Log your study sessions and track your focus and progress over time.</p>
            </div>
            <div class="feature">
    ...
    <section id="about" class="about">
        <h2>About MOOD</h2>
        <p>MOOD is designed to help you stay focused, track your progress, and maintain a productive study environment. Whether you're working on assignments, learning new skills, or preparing for exams, MOOD helps you create the perfect atmosphere for success.</p>
    </section>
